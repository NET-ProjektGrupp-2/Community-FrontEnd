...
export const EKey_NavLogin = "/login";
export const EKey_SubmitLogin = "login?";
export const EKey_NavLogout = "/logout";
export const EKey_SubmitLogout = "logout?";
export const EKey_NavRegister = "/register";
export const EKey_SubmitRegister = "register?";

export const EKey_NavViewUsers = "/viewUsers";
export const EKey_NavAccount = "/manageAccount";

export const EKey_NavForum = "/forum/*";
export const EKey_SubmitForum = "forum?";
export const EKey_NavTopic = "/topic/";
export const EKey_SubmitTopic = "topic?";
export const EKey_NavPost = "/post/";
